$(document).ready(function() {
    ...
    function generateLossDueToTimeOut() {
        unansweredTally++;
        gameHTML = "<p class='timer'>Count Down: <span class='timer'>" + counter + "</span></p>" + "<p class='text-center'>You ran out of time!  The correct answer was: " + correctAnswers[questionCounter] + "</p>" + "<img class='center-block img-wrong' src='assets/images/neversaydie.jpg'>";
    ...
    function generateWin() {
        correctTally++;
        gameHTML = "<p class='timer'>Count Down: <span class='timer'>" + counter + "</span></p>" + "<p class='text-center'>Correct! The answer is: " + correctAnswers[questionCounter] + "</p>" + imageArray[questionCounter];
        $(".mainArea").html(gameHTML);
        setTimeout(wait, 4000);  
    }
    ...
    function generateLoss() {
        incorrectTally++;
        gameHTML = "<p class='timer'>Count Down: <span class='timer'>" + counter + "</span></p>" + "<p class='text-center'>Wrong! The correct answer is: "+ correctAnswers[questionCounter] + "</p>" + "<img class='center-block img-wrong' src='assets/images/monster.jpg'>";
        $(".mainArea").html(gameHTML);
        setTimeout(wait, 4000); 
    }
    //functions for mutiple choose QandA
    //array of Q ad A and timer on the html
    function generateHTML() {
        gameHTML = "<p class='timer'>Count Down: <span class='timer'>30</span></p><p class='text-center'>" + questionArray[questionCounter] + "</p><p class='answer'>A. " + answerArray[questionCounter][0] + "</p><p class='answer'>B. "+answerArray[questionCounter][1]+"</p><p class='answer'>C. "+answerArray[questionCounter][2]+"</p><p class='answer'>D. "+answerArray[questionCounter][3]+"</p>";
        $(".mainArea").html(gameHTML);
    }
    //finish last questions show final screen
    function wait() {
    ...
    function finalScreen() {
        gameHTML = "<p class='timer'>Count Down: <span class='timer'>" + counter + "</span></p>" + "<p class='text-center'>All done, here's how you did!" + "</p>" + "<p class='summary-correct'>Correct Answers: " + correctTally + "</p>" + "<p>Wrong Answers: " + incorrectTally + "</p>" + "<p>Unanswered: " + unansweredTally + "</p>" + "<p class='text-center'><a class='reset-button' href='#' role='button'>Reset The Quiz!</a></p>";
        $(".mainArea").html(gameHTML);
    }
    ...
    var imageArray = ["<img class='center-block img-right' src='assets/images/frankmonster.jpg'>", "<img class='center-block img-right' src='assets/images/cyclops.jpg'>", "<img class='center-block img-right' src='assets/images/kraken.jpg'>", "<img class='center-block img-right' src='assets/images/fred.jpg'>", "<img class='center-block img-right' src='assets/images/sharktopus2.jpg'>", "<img class='center-block img-right' src='assets/images/Minotaur.jpg'>", "<img class='center-block img-right' src='assets/images/imhotep2.jpg'>", "<img class='center-block img-right' src='assets/images/maneater2.jpg'>"];
